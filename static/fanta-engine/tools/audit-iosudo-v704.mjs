...
const js = fs.readFileSync('static/fanta-engine/js/apps/iosudo-app-v704.js', 'utf8');
...
assertOk(index.includes('iosudo-app-v704.js?v=704'), 'index non punta al JS V704');
assertOk(index.includes('iosudo-app-v704.css?v=704'), 'index non punta al CSS V704');
assertOk(sw.includes('iosudo-shell-v704'), 'service worker non usa cache V704');
assertOk(sw.includes('iosudo-app-v704.js?v=704'), 'service worker non cachea JS V704');
assertOk(manifest.version === 'V704', 'manifest non aggiornato a V704');
...
console.log('Audit ioSudo V704 OK', JSON.stringify({players: manifest.players, talks: manifest.teamTransferTalks, official: manifest.officialMoves, friendlies: manifest.friendlies, injuries: manifest.injuries}));
