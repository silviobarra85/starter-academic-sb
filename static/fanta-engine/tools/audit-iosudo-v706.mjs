...
const js = fs.readFileSync('static/fanta-engine/js/apps/iosudo-app-v706.js', 'utf8');
const css = fs.readFileSync('static/fanta-engine/css/iosudo-app-v706.css', 'utf8');
...
assertOk(index.includes('iosudo-app-v706.js?v=706'), 'index non punta al JS V706');
assertOk(index.includes('iosudo-app-v706.css?v=706'), 'index non punta al CSS V706');
assertOk(index.includes('data-iosudo-version="706"'), 'index non ha data-iosudo-version 706');
assertOk(sw.includes('iosudo-shell-v706'), 'service worker non usa cache V706');
assertOk(sw.includes('iosudo-app-v706.js?v=706'), 'service worker non cachea JS V706');
assertOk(sw.includes('iosudo-app-v706.css?v=706'), 'service worker non cachea CSS V706');
assertOk(manifest.version === 'V706', 'manifest non aggiornato a V706');
assertOk(data.meta?.version === 'V706', 'sudatori-data meta.version non aggiornato a V706');
...
assertOk(manifest.dedupVersion && manifest.dedupVersion.includes('V706'), 'dedupVersion non aggiornata a V706');
...
console.log('Audit ioSudo V706 OK', JSON.stringify({
