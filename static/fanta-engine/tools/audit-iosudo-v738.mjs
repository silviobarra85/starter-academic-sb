...
const errors = [];
if (manifest.version !== 'V738') errors.push(`manifest version ${manifest.version}`);
...
if (errors.length) { console.error('Audit ioSudo V738 FAILED'); for (const e of errors) console.error('-', e); process.exit(1); }
console.log('Audit ioSudo V738 OK');
