(function () {
  ...
  function setupLeagueChrome() {
    ...
    document.title = 'ioSudo V769 - ' + league.name;
  }
  ...
  function buildPlayerCatalogIndexesV757() {
    ...
    window.ioSudoDiagnosticsV782 = Object.freeze(Object.assign({ version: 'V782', sosFlagMode: 'active-injury-index-only', sourceBadgeMode: 'catalog-membership-listone-first', anagraficaVisible: false, identityMode: 'full-name-team-scoped', musahCurrentTeam: 'Milan', giovaneProtected: true, pessinaProtected: true, bordonProtected: true, protectedBordonAuditV770: state.protectedBordonAuditV770 || null, protectedIdentityAuditV768: state.protectedIdentityAuditV768 || null }, state.catalogStatsV757));
  }
  ...
  function renderPlayerDetail(playerId, teamId) {
    ...
    try {
      ...
      console.error('[ioSudo V769] errore dettaglio giocatore', error);
      if (els.focus) {
...
/* V782: Excel V169, dati al 31/07/2026 10:50 CEST, identità persistenti e audit completo. */
