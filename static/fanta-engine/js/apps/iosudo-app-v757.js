(function () {
  ...
  function buildPlayerCatalogIndexesV757() {
    ...
    window.ioSudoDiagnosticsV757 = Object.freeze(Object.assign({ version: 'V757' }, state.catalogStatsV757));
  }
  ...
  function renderPlayerDetail(playerId, teamId) {
    ...
    try {
      ...
      console.error('[ioSudo V757] errore dettaglio giocatore', error);
      if (els.focus) {
