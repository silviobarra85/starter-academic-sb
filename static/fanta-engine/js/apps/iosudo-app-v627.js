(function () {
  ...
  function teamKey(value) {
    ...
    return TEAM_ALIAS_V627.get(key) || key;
  }
  ...
  async function loadLeagueRosters() {
    ...
    try {
      ...
      console.warn('[ioSudo V627] Rose live non caricate: uso snapshot Sudatori incorporato.', error);
    }
  }
  ...
  async function loadLatestListone() {
    ...
    try {
      ...
      console.warn('[ioSudo V627] Listone piu recente non caricato.', error);
    }
  }
