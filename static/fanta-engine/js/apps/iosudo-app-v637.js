(function () {
  ...
  function teamKey(value) {
    ...
    return TEAM_ALIAS_V637.get(key) || key;
  }

  const NAME_ALIAS_V637 = new Map([
    ['kilicksoy', 'kilicsoy'],
    ['kilicsoy', 'kilicsoy'],
  ...
  function canonName(value) {
    ...
    return NAME_ALIAS_V637.get(raw) || raw;
  }
  ...
  async function loadLeagueRosters() {
    ...
    try {
      ...
      console.warn('[ioSudo V637] Rose live non caricate: uso snapshot Sudatori incorporato.', error);
    }
  }
  ...
  async function loadLatestListone() {
    ...
    try {
      ...
      console.warn('[ioSudo V637] Listone piu recente non caricato.', error);
    }
  }
  ...
  function collectPlayerRows() {
    ...
    return Array.from(rowsByKey.values()).filter(function (record) {
      return shouldShowInGlobalPlayers(record.player);
    }).sort(function (a, b) {
