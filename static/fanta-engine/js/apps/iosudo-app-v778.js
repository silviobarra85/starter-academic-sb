(function () {
  ...
  function setupLeagueChrome() {
    ...
    document.title = 'ioSudo V778 - ' + league.name;
  }
  ...
  function renderPlayerDetail(playerId, teamId) {
    ...
    try {
      ...
      console.error('[ioSudo V778] errore dettaglio giocatore', error);
      if (els.focus) {
...
/* V778: Excel V164; rumor runtime ripristinati con bucket incoming/outgoing/other e tre nuovi tabellini completi. */
