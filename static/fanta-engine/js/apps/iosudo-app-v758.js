(function () {
  ...
  function buildPlayerCatalogIndexesV757() {
    ...
    window.ioSudoDiagnosticsV758 = Object.freeze(Object.assign({ version: 'V758', sourceBadgeMode: 'catalog-membership-listone-first', anagraficaVisible: false }, state.catalogStatsV757));
  }
  ...
  function normalizeNameSource(value) {
    ...
    // V758: ANAGRAFICA/ALIAS descrive solo come e stato ricostruito il nome,
  ...
  function playerNameSourceKind(player) {
    ...
    // V758: la presenza nel listone ha sempre priorita sul metodo interno
  ...
  function renderPlayerDetail(playerId, teamId) {
    ...
    try {
      ...
      console.error('[ioSudo V758] errore dettaglio giocatore', error);
      if (els.focus) {
...
/* V758: badge sorgente basato sulla presenza nel catalogo; LISTONE prioritario, ANAGRAFICA solo interna. */
