(function () {
  ...
  function setupLeagueChrome() {
    ...
    document.title = 'ioSudo V780 - ' + league.name;
  }
  ...
  function renderPlayerDetail(playerId, teamId) {
    ...
    try {
      ...
      console.error('[ioSudo V780] errore dettaglio giocatore', error);
      if (els.focus) {
...
/* V780: Excel V167; rumor runtime ripristinati con bucket incoming/outgoing/other e rinnovo Vergara, Quintero e mercato V167. */
