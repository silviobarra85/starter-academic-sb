(function () {
  ...
  function collectFastPlayerRows() {
    ...
    // V656: performance mobile: i giocatori presenti solo in RUMOR/UFFICIALITA non vengono materializzati in GIOCATORI; la Rosa resta disponibile dentro la scheda squadra.
