(function () {
  ...
  function liveSummaryCount(key) {
    ...
    if (key === 'players') {
      // V753: allinea il KPI alla vista GIOCATORI effettivamente renderizzata.
  ...
  function collectFastPlayerRows() {
    ...
    rows.sort(function (a, b) {
      // V753: i giocatori con rumor/notizie/SOS/ufficialità più recenti devono stare più in alto.
  ...
  function globalMarketItem(row, badgeText) {
    ...
    const html = '<article class="iosudo-list-row iosudo-compact-row iosudo-market-row-compact"><h4>'
      + escapeHtml(name) + ' <span class="iosudo-badge ' + badgeCls + '">' + escapeHtml(effectiveBadgeText) + '</span></h4>'
  ...
  function teamPlayersList(teamId) {
    return teamPlayers(teamId).slice().sort(function (a, b) {
      // V753: nelle rose il ruolo e il criterio principale: P, D, C, A.
...
/* V753: Excel V126 integrato; Palma rinnovo Udinese; dedupe Atalanta-Atalanta U23; Kostić/Kostic disambiguati. */

/* V753: Excel V128 integrato; SOS Napoli aggiornati; trattative non ufficiali V128; dedupe amichevoli confermata. */
