(function () {
  ...
  function buildPlayerCatalogIndexesV757() {
    ...
    window.ioSudoDiagnosticsV759 = Object.freeze(Object.assign({ version: 'V759', sourceBadgeMode: 'catalog-membership-listone-first', anagraficaVisible: false, identityMode: 'full-name-team-scoped', musahCurrentTeam: 'Milan', giovaneProtected: true }, state.catalogStatsV757));
  }
  ...
  function normalizeNameSource(value) {
    ...
    // V759: ANAGRAFICA/ALIAS descrive solo come e stato ricostruito il nome,
  ...
  function playerNameSourceKind(player) {
    ...
    // V759: la presenza nel listone ha sempre priorita sul metodo interno
  ...
  function renderPlayerDetail(playerId, teamId) {
    ...
    try {
      ...
      console.error('[ioSudo V759] errore dettaglio giocatore', error);
      if (els.focus) {
...
/* V759: badge sorgente basato sulla presenza nel catalogo; LISTONE prioritario, ANAGRAFICA solo interna. */
