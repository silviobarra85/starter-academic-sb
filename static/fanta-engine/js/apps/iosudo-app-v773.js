(function () {
  ...
  function buildPlayerCatalogIndexesV757() {
    ...
    window.ioSudoDiagnosticsV773 = Object.freeze(Object.assign({ version: 'V773', sosFlagMode: 'active-injury-index-only', sourceBadgeMode: 'catalog-membership-listone-first', anagraficaVisible: false, identityMode: 'full-name-team-scoped', musahCurrentTeam: 'Milan', giovaneProtected: true, pessinaProtected: true, bordonProtected: true, protectedBordonAuditV770: state.protectedBordonAuditV770 || null, protectedIdentityAuditV768: state.protectedIdentityAuditV768 || null }, state.catalogStatsV757));
  }
...
/* V773: Excel V158; catalogo ricostruito, duplicati verificati, header sincronizzato. */

/* V773: Excel V158; deduplica globale e header sincronizzato. */

/* V773: probabili XI V159, 20 squadre e 220 slot indicizzati per ID canonico. */
