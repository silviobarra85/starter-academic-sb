(function () {
  ...
  function teamKey(value) {
    ...
    return TEAM_ALIAS_V620.get(key) || key;
  }
  ...
  async function loadLeagueRosters() {
    ...
    try {
      ...
      console.warn('[ioSudo V620] Rose live non caricate: uso snapshot Sudatori incorporato.', error);
    }
  }
