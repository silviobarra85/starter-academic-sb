(function () {
  ...
  function buildPlayerCatalogIndexesV757() {
    ...
    window.ioSudoDiagnosticsV770 = Object.freeze(Object.assign({ version: 'V770', sosFlagMode: 'active-injury-index-only', sourceBadgeMode: 'catalog-membership-listone-first', anagraficaVisible: false, identityMode: 'full-name-team-scoped', musahCurrentTeam: 'Milan', giovaneProtected: true, pessinaProtected: true, bordonProtected: true, protectedBordonAuditV770: state.protectedBordonAuditV770 || null, protectedIdentityAuditV768: state.protectedIdentityAuditV768 || null }, state.catalogStatsV757));
  }
