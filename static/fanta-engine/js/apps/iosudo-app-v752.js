(function () {
  ...
  function liveSummaryCount(key) {
    ...
    if (key === 'players') {
      // V752: allinea il KPI alla vista GIOCATORI effettivamente renderizzata.
  ...
  function collectFastPlayerRows() {
    ...
    rows.sort(function (a, b) {
      // V752: i giocatori con rumor/notizie/SOS/ufficialità più recenti devono stare più in alto.
...
/* V752: Excel V126 integrato; Palma rinnovo Udinese; dedupe Atalanta-Atalanta U23; Kostić/Kostic disambiguati. */

/* V752: Excel V128 integrato; SOS Napoli aggiornati; trattative non ufficiali V128; dedupe amichevoli confermata. */
