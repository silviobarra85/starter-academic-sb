(function () {
  ...
  function setupLeagueChrome() {
    ...
    document.title = 'ioSudo V768 - ' + league.name;
  }
  ...
  function buildPlayerCatalogIndexesV757() {
    ...
    window.ioSudoDiagnosticsV768 = Object.freeze(Object.assign({ version: 'V768', sourceBadgeMode: 'catalog-membership-listone-first', anagraficaVisible: false, identityMode: 'full-name-team-scoped', musahCurrentTeam: 'Milan', giovaneProtected: true, pessinaProtected: true, protectedIdentityAuditV768: state.protectedIdentityAuditV768 || null }, state.catalogStatsV757));
  }
  ...
  function renderPlayerDetail(playerId, teamId) {
    ...
    try {
      ...
      console.error('[ioSudo V768] errore dettaglio giocatore', error);
      if (els.focus) {
