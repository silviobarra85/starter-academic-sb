(function () {
  ...
  function liveSummaryCount(key) {
    // V658: le card di riepilogo devono contare le stesse voci mostrate dalle viste rapide.
  ...
  function collectFastPlayerRows() {
    ...
    // V658: performance mobile: i giocatori presenti solo in RUMOR/UFFICIALITA non vengono materializzati in GIOCATORI; la Rosa resta disponibile dentro la scheda squadra.
