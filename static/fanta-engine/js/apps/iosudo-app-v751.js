(function () {
  ...
  function liveSummaryCount(key) {
    ...
    if (key === 'players') {
      // V751: allinea il KPI alla vista GIOCATORI effettivamente renderizzata.
  ...
  function collectFastPlayerRows() {
    ...
    rows.sort(function (a, b) {
      // V751: i giocatori con rumor/notizie/SOS/ufficialità più recenti devono stare più in alto.
...
/* V751: Excel V126 integrato; Palma rinnovo Udinese; dedupe Atalanta-Atalanta U23; Kostić/Kostic disambiguati. */

/* V751: Excel V128 integrato; SOS Napoli aggiornati; trattative non ufficiali V128; dedupe amichevoli confermata. */
