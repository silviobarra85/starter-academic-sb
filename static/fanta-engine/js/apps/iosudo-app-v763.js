(function () {
  ...
  function buildPlayerCatalogIndexesV757() {
    ...
    window.ioSudoDiagnosticsV763 = Object.freeze(Object.assign({ version: 'V763', sourceBadgeMode: 'catalog-membership-listone-first', anagraficaVisible: false, identityMode: 'full-name-team-scoped', musahCurrentTeam: 'Milan', giovaneProtected: true }, state.catalogStatsV757));
  }
  ...
  function normalizeNameSource(value) {
    ...
    // V763: ANAGRAFICA/ALIAS descrive solo come e stato ricostruito il nome,
  ...
  function playerNameSourceKind(player) {
    ...
    // V763: la presenza nel listone ha sempre priorita sul metodo interno
  ...
  function renderPlayerDetail(playerId, teamId) {
    ...
    try {
      ...
      console.error('[ioSudo V763] errore dettaglio giocatore', error);
      if (els.focus) {
...
/* V763: badge sorgente basato sulla presenza nel catalogo; LISTONE prioritario, ANAGRAFICA solo interna. */
