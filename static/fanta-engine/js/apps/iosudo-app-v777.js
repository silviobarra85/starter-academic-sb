(function () {
  ...
  function setupLeagueChrome() {
    ...
    document.title = 'ioSudo V777 - ' + league.name;
  }
  ...
  function renderPlayerDetail(playerId, teamId) {
    ...
    try {
      ...
      console.error('[ioSudo V777] errore dettaglio giocatore', error);
      if (els.focus) {
...
/* V777: Excel V164; rumor runtime ripristinati con bucket incoming/outgoing/other e tre nuovi tabellini completi. */
