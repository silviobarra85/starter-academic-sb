(function () {
  ...
  function friendlyStatRow(row) {
    ...
    return '<article class="iosudo-friendly-stat-row">'
      + '<div class="iosudo-friendly-stat-main"><strong>' + escapeHtml(row.playerName || 'Giocatore') + '</strong>' + role + '</div>'
  ...
  function renderFriendlyDetail(matchKey, teamId) {
    ...
    els.focus.innerHTML = '<div class="iosudo-panel-header iosudo-friendly-detail-header"><div>'
      ...
      + sourcesHtml(item)
      + '</div>'
      + '<div class="iosudo-friendly-detail-actions"><button class="iosudo-secondary-action" type="button" data-back-team="true">Torna alla squadra</button></div>'
      + statRows;
...
// V720: Excel V75; rinnovi ufficiali Roma, Bologna-Arminia 0-4 con tabellino giocatori, 10 alias confermati applicati.

// V720 safety: no generic alias for Esposito; mantenuta disambiguazione S./F. Esposito e candidati duplicato non fusi senza conferma.

// V720: Bologna-Arminia cliccabile con badge minuti/titolare/gol/autogol/infortunio gara da tabellino ufficiale.
