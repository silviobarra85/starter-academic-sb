(function () {
  ...
  function setupLeagueChrome() {
    ...
    document.title = 'ioSudo V779 - ' + league.name;
  }
  ...
  function renderPlayerDetail(playerId, teamId) {
    ...
    try {
      ...
      console.error('[ioSudo V779] errore dettaglio giocatore', error);
      if (els.focus) {
...
/* V779: Excel V166; rumor runtime ripristinati con bucket incoming/outgoing/other e rinnovo Vergara, Quintero e mercato V166. */
