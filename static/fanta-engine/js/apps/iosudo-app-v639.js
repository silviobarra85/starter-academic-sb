(function () {
  ...
  function teamKey(value) {
    ...
    return TEAM_ALIAS_V639.get(key) || key;
  }

  const NAME_ALIAS_V639 = new Map([
    ['kilicksoy', 'kilicsoy'],
    ['kilicsoy', 'kilicsoy'],
  ...
  function canonName(value) {
    ...
    return NAME_ALIAS_V639.get(raw) || raw;
  }
  ...
  async function loadLeagueRosters() {
    ...
    try {
      ...
      console.warn('[ioSudo V639] Rose live non caricate: uso snapshot Sudatori incorporato.', error);
    }
  }
  ...
  async function loadLatestListone() {
    ...
    try {
      ...
      console.warn('[ioSudo V639] Listone piu recente non caricato.', error);
    }
  }
