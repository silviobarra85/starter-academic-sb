...
check('CSS V456 collegato in index', /admin-card-visibility-v456\.css\?v=\d+/.test(index));
check('JS V456 collegato in index', /admin-card-visibility-v456\.js\?v=\d+/.test(index));
check('script V455 non piu collegato in index', !index.includes('admin-card-visibility-v455.js'));
