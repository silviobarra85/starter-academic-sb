...
check('runtime deploy V438 in app.js', /DEPLOY_EXPECTED_VERSION_V181\s*=\s*"438"/.test(app));
check('footer e cache-buster V438 in index', index.includes('?v=438') && index.includes('V438 fix mobile bilanci'));
...
if (ok !== total) {
  console.error(`Audit bilanci mobile V437 compatibile V438 completato: ${ok}/${total} controlli superati.`);
  process.exit(1);
}
console.log('Audit bilanci mobile V437 compatibile V438 superato.');
