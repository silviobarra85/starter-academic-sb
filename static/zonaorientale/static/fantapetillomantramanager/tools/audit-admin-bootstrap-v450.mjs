...
try {
  ...
  check(!index.includes('fanta-petillo-firebase-bootstrap-v449.js?v=467'), 'guard V449 non caricato in index');
  ...
  check(Number((app.match(/DEPLOY_EXPECTED_VERSION_V181 = \"(\d+)\"/) || [])[1] || 0) >= 450, 'DEPLOY_EXPECTED_VERSION clone V450+');
