...
for (const page of pages) {
  ...
  check(`${page} usa favicon PNG cache-proof V455`, /fantapetillo-favicon-v455-32\.png\?v=\d+/.test(html));
  check(`${page} usa apple touch cache-proof V455`, /fantapetillo-apple-touch-icon-v455\.png\?v=\d+/.test(html));
}
