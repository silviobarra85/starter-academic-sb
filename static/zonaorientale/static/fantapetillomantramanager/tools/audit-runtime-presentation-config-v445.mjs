...
check('home carica loader/cache V445 e data page', index.includes('league-config-v443.js?v=466') && index.includes('assets/app.js?v=466') && index.includes('data-league-page="home"'));
check('standalone caricano loader/cache V445 e data page', competition.includes('league-config-v443.js?v=466') && player.includes('league-config-v443.js?v=466') && competition.includes('data-league-page="competition"') && player.includes('data-league-page="player"'));
...
check('Bilanci continua a usare config con fallback', bilanciSection.includes('league-config-v443.js?v=466') && bilanciSection.includes('getLeagueWhatsappBilanciUrlV443'));
