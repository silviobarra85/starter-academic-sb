...
function mountRegolamentoSectionV402() {
  const host = document.querySelector('[data-page="regolamento"][data-section-template="regolamento-v402"]');
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', mountRegolamentoSectionV402, { once: true });
} else {
  mountRegolamentoSectionV402();
}

window.ZonaOrientaleRegolamentoSectionV402 = Object.freeze({
  version: 'V402',
  section: 'regolamento',
