...
check('runtime V436 in app.js', Number(app.match(/DEPLOY_EXPECTED_VERSION_V181\s*=\s*"(\d+)"/)?.[1] || 0) >= 436);
...
check('CSS edit movimenti collegato in index', index.includes('assets/css/refactor/admin-fm-movement-edit-v436.css?v=466'));
...
check('badge V434 resta collegato', index.includes('assets/device-badge-v434.css?v=466') && index.includes('assets/device-badge-v434.js?v=466'));
check('bilanci da snapshot resta collegato', index.includes('bilanci-snapshot-section-v435.js?v=466'));
