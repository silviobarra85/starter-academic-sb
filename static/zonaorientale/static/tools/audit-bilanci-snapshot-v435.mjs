...
check('runtime deploy almeno V435 in app.js', Number(app.match(/DEPLOY_EXPECTED_VERSION_V181\s*=\s*"(\d+)"/)?.[1] || 0) >= 435);
...
check('CSS bilanci collegato', index.includes('assets/css/refactor/bilanci-snapshot-v435.css?v=466'));
check('JS bilanci collegato', index.includes('assets/js/sections/bilanci-snapshot-section-v435.js?v=466'));
