...
check('index carica loader V443', index.includes(`league-config-v443.js?v=${config.currentVersion}`));
check('standalone caricano loader V443', competition.includes(`league-config-v443.js?v=${config.currentVersion}`) && player.includes(`league-config-v443.js?v=${config.currentVersion}`));
check('cache-buster runtime V445+', index.includes(`assets/app.js?v=${config.currentVersion}`) && !index.includes('?v=466') && !index.includes('?v=466'));
