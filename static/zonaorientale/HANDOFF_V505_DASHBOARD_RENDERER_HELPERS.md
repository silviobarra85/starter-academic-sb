...
La V505 introduce `dashboard-renderer-helpers-v505.js` in `fanta-engine` e usa il renderer comune per la shell dei pannelli Admin collassabili di ZonaOrientale.
