...
## V513 - Audit runtime boot

Comando locale dalla cartella lega:

```bash
node tools/audit-runtime-boot-v513.mjs
```

Controlla che il bug `formValidatorsV506` non sia piu' presente, che il footer/cache-buster siano V513 e che `app.js` importi il config corretto.
