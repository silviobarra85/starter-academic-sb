...
const CONFIG_URL_V443 = './assets/league-config.json?v=446';
...
function applyBrandTextV445() {
  ...
  setTextForSelectorV445('[data-league-footer-v445]', `${siteName} · V${footerVersion} path dati statici da config · Ultimo aggiornamento 15/06/2026`);
}
