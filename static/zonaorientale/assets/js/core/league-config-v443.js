...
const DEFAULT_LEAGUE_CONFIG_V443 = Object.freeze({
  ...
  features: Object.freeze({
    ...
    presidentTradeAnnouncement: true,
    mantraFilters: true,
  ...
  featureCardRegistry: Object.freeze({
    ...
    cards: Object.freeze([
      ...
      Object.freeze({
        id: 'trade-announcement',
        title: 'Comunicato avvenuto scambio',
        enabled: true,
        visibility: 'president',
        featureKey: 'presidentTradeAnnouncement',
        hiddenForAdmin: true,
        leagues: Object.freeze(['zonaorientale']),
        order: 130,
        safeEnforce: true,
...
const CONFIG_URL_V443 = './assets/league-config.json?v=810';
