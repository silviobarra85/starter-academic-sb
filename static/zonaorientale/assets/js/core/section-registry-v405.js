...
const ZONA_ORIENTALE_SECTIONS_V480 = [
  ...
  { id: 'teamarea', label: 'Area squadra', visibility: 'president', area: 'presidents', source: 'dynamic-v34', nav: { order: 45, desktop: true, mobilePrimary: true, mobileMore: false, label: 'Area squadra', icon: 'team' }, dashboardCard: { enabled: true, order: 10, title: 'Area squadra', description: 'Richieste operative e strumenti presidente.', audience: 'president' } },
...
const SECTION_REGISTRY_V405 = createUnifiedSectionRegistryV480({
  ...
  sections: ZONA_ORIENTALE_SECTIONS_V480
});
...
const ZONA_ORIENTALE_SECTION_REGISTRY_V480_EXPORT = Object.freeze({
...
installUnifiedSectionRegistryV480(ZONA_ORIENTALE_SECTION_REGISTRY_V480_EXPORT, [
  'ZonaOrientaleSectionRegistryV480',
  'ZonaOrientaleSectionRegistryV405',
  'ZonaOrientaleSectionRegistryV404',
  'ZonaOrientaleSectionRegistryV403',
  'ZonaOrientaleSectionRegistryV402',
  'ZonaOrientaleSectionRegistryV401'
]);

export { ZONA_ORIENTALE_SECTION_REGISTRY_V480_EXPORT as SECTION_REGISTRY_V405 };
