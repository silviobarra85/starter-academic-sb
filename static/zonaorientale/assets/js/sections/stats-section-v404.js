const STATS_SECTION_HTML_V404 = `    <section class="app-page" data-page="stats" aria-labelledby="statsTitle">
      <div class="page-heading">
        <div>
          ...
          <p>Record, titoli, podi e protagonisti della storia ZonaOrientale. Usa solo dati gia' caricati da JSON statici o snapshot, senza letture Firebase aggiuntive.</p>
        </div>
      </div>
...
window.ZonaOrientaleStatsSectionV404 = Object.freeze({
  version: 'V404',
  template: 'stats-v404',
