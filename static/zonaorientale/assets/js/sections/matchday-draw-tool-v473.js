// V506 - Wrapper locale per Sorteggio giornate.
// Runtime primario: fanta-engine/js/tools/matchday-draw-engine-v506.js
// Fallback: logica locale V473 preservata in caso di errore caricamento motore comune.

function getLeagueSlugLocalV506() {
...
function initMatchdayDrawToolFallbackV473() {
...
async function bootstrapMatchdayDrawToolV506() {
  try {
    const module = await import('../../../../fanta-engine/js/tools/matchday-draw-engine-v506.js?v=506');
    module.initMatchdayDrawToolV506({
      leagueSlug: getLeagueSlugLocalV506(),
      legacyUiVersion: 'V473',
      seedVersion: '506'
    });
  } catch (error) {
    console.warn('Motore comune Sorteggio giornate V506 non disponibile: uso fallback locale V473.', error);
    initMatchdayDrawToolFallbackV473();
  }
}

bootstrapMatchdayDrawToolV506();
