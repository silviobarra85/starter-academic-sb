...
try {
  ...
  check(read(path.join(cloneRoot, 'index.html')).includes('fanta-petillo-sandbox-v448.js?v=448') || read(path.join(cloneRoot, 'index.html')).includes('fanta-petillo-firebase-bootstrap-v449.js?v=449') || read(path.join(cloneRoot, 'index.html')).includes('fanta-petillo-admin-bootstrap-v450.js?v=456') || read(path.join(cloneRoot, 'index.html')).includes('fanta-petillo-admin-bootstrap-v450.js?v=455'), 'home carica guard sandbox/bootstrap');
  check(read(path.join(cloneRoot, 'competition.html')).includes('fanta-petillo-sandbox-v448.js?v=448') || read(path.join(cloneRoot, 'competition.html')).includes('fanta-petillo-firebase-bootstrap-v449.js?v=449') || read(path.join(cloneRoot, 'competition.html')).includes('fanta-petillo-admin-bootstrap-v450.js?v=456') || read(path.join(cloneRoot, 'competition.html')).includes('fanta-petillo-admin-bootstrap-v450.js?v=455'), 'competition carica guard sandbox/bootstrap');
  check(read(path.join(cloneRoot, 'player.html')).includes('fanta-petillo-sandbox-v448.js?v=448') || read(path.join(cloneRoot, 'player.html')).includes('fanta-petillo-firebase-bootstrap-v449.js?v=449') || read(path.join(cloneRoot, 'player.html')).includes('fanta-petillo-admin-bootstrap-v450.js?v=456') || read(path.join(cloneRoot, 'player.html')).includes('fanta-petillo-admin-bootstrap-v450.js?v=455'), 'player carica guard sandbox/bootstrap');
