...
check('home carica loader/cache V445 e data page', index.includes(`league-config-v443.js?v=${config.currentVersion}`) && index.includes(`assets/app.js?v=${config.currentVersion}`) && index.includes('data-league-page="home"'));
check('standalone caricano loader/cache V445 e data page', competition.includes(`league-config-v443.js?v=${config.currentVersion}`) && player.includes(`league-config-v443.js?v=${config.currentVersion}`) && competition.includes('data-league-page="competition"') && player.includes('data-league-page="player"'));
