...
check('runtime V436 in app.js', /DEPLOY_EXPECTED_VERSION_V181\s*=\s*"(436|437|438|439|440)"/.test(app));
...
check('CSS edit movimenti collegato in index', /assets\/css\/refactor\/admin-fm-movement-edit-v436\.css\?v=(436|437|438|439|440)/.test(index));
...
check('badge V434 resta collegato', /assets\/device-badge-v434\.css\?v=(436|437|438|439|440)/.test(index) && /assets\/device-badge-v434\.js\?v=(436|437|438|439|440)/.test(index));
check('bilanci da snapshot resta collegato', /assets\/js\/sections\/bilanci-snapshot-section-v435\.js\?v=(436|437|438|439|440)/.test(index));
