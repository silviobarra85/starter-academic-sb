...
html.includes('Soccer Data') && (html.includes('V383') || html.includes('V384') || html.includes('V385') || html.includes('V386') || html.includes('V396')) ? pass('HTML Soccer Data presente in runtime V383+ conservato') : fail('HTML Soccer Data non rilevato in runtime V383+');
