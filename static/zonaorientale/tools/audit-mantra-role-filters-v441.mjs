...
if (!index.includes('mantra-role-filters-v441.css?v=451')) failures.push('CSS V441 non collegato in index.html');
...
if (!/DEPLOY_EXPECTED_VERSION_V181 = "(442|443|444|445|446|447|448|449|450|451)"/.test(app)) failures.push('DEPLOY_EXPECTED_VERSION_V181 non compatibile con V441+');
