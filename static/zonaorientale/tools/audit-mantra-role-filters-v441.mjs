...
if (!index.includes('mantra-role-filters-v441.css?v=442')) failures.push('CSS V441 non collegato in index.html');
...
if (!/DEPLOY_EXPECTED_VERSION_V181 = "442"/.test(app)) failures.push('DEPLOY_EXPECTED_VERSION_V181 non aggiornato a 441');
