...
if (!/DEPLOY_EXPECTED_VERSION_V181 = "(442|443|444|445|446|447|448|449|450|451|452)"/.test(app)) failures.push('DEPLOY_EXPECTED_VERSION_V181 non compatibile con V441+');
