...
check('runtime deploy almeno V438 in app.js', /DEPLOY_EXPECTED_VERSION_V181\s*=\s*"(438|439|440)"/.test(app));
check('footer e cache-buster almeno V438 in index', (/\?v=(438|439|440)/.test(index) && (index.includes('V438 fix mobile bilanci') || index.includes('V439 menu Altro pagine standalone') || index.includes('V440 link WhatsApp Bilanci'))));
