...
check('runtime deploy almeno V438 in app.js', /DEPLOY_EXPECTED_VERSION_V181\s*=\s*"(438|439|440|441|442|443|444|445|446|447|448|449|450|451)"/.test(app));
check('footer e cache-buster almeno V438 in index', (/\?v=(438|439|440|441|442|443|444|445|446|447|448|449|450|451)/.test(index) && (index.includes('V438 fix mobile bilanci') || index.includes('V439 menu Altro pagine standalone') || index.includes('V440 link WhatsApp Bilanci') || index.includes('V441 filtri ruoli Mantra') || index.includes('V442 titoli sopra filtri') || index.includes('V444 audit hard-coded multi-lega') || index.includes('V446 path dati statici da config') || index.includes('V447 clone sandbox FantaPetillo') || index.includes('V449 Firebase FantaPetillo') || index.includes('V450 Admin bootstrap FantaPetillo') || index.includes('V451 onboarding dati FantaPetillo'))));
