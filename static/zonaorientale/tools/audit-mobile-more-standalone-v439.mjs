...
const expectedVersions = ['439', '440', '441', '442', '443', '444', '445', '446', '447', '448'];
...
push(/DEPLOY_EXPECTED_VERSION_V181\s*=\s*"(439|440|441|442|443|444|445|446|447|448)"/.test(app), 'app.js: DEPLOY_EXPECTED_VERSION_V181 V439+');
