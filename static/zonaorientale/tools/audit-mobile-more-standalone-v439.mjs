...
const expectedVersions = ['439', '440', '441', '442'];
...
for (const file of files) {
  ...
  push(html.includes('V439 menu Altro pagine standalone') || html.includes('V440 link WhatsApp Bilanci') || html.includes('V441 filtri ruoli Mantra') || html.includes('V442 titoli sopra filtri'), `${file}: footer V439+`);
...
push(/DEPLOY_EXPECTED_VERSION_V181\s*=\s*"(439|440|441|442)"/.test(app), 'app.js: DEPLOY_EXPECTED_VERSION_V181 V439+');
