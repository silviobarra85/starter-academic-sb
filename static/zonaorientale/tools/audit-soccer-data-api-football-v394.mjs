...
assert(index.includes('app.js?v=394'), 'cache buster index non aggiornato a V394');
assert(index.includes('V394 Soccer Data API-Football cache Firebase'), 'footer V394 non aggiornato');
