...
check('reader listoni rose competizioni usa dataPaths', staticFiles.includes('getLeagueDataPathV446("listoniManifest"') && staticFiles.includes('joinLeagueDataPathV446("rostersBase"') && staticFiles.includes('getLeagueDataPathV446("competitionsManifest"'));
