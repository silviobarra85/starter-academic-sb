...
check('runtime deploy almeno V435 in app.js', /DEPLOY_EXPECTED_VERSION_V181\s*=\s*"(435|436|437|438|439|440)"/.test(app));
...
check('CSS bilanci collegato', /assets\/css\/refactor\/bilanci-snapshot-v435\.css\?v=(435|436|437|438|439|440)/.test(index));
check('JS bilanci collegato', /assets\/js\/sections\/bilanci-snapshot-section-v435\.js\?v=(435|436|437|438|439|440)/.test(index));
...
check('badge V434 resta collegato', /assets\/device-badge-v434\.css\?v=(435|436|437|438|439|440)/.test(index) && /assets\/device-badge-v434\.js\?v=(435|436|437|438|439|440)/.test(index));
