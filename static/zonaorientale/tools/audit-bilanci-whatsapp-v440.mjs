...
check('runtime deploy V440 in app.js', /DEPLOY_EXPECTED_VERSION_V181\s*=\s*"(440|441|442|443|444|445|446|447|448|449|450|451|452|453)"/.test(app));
check('index cache-buster V440 per Bilanci', index.includes('bilanci-snapshot-section-v435.js?v=453') && index.includes('bilanci-snapshot-v435.css?v=453'));
