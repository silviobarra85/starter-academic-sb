...
assert(index.includes('panel-title-stack-v442.css?v=446'), 'CSS V442 caricato in index');
assert(competition.includes('panel-title-stack-v442.css?v=446'), 'CSS V442 caricato in competition');
assert(player.includes('panel-title-stack-v442.css?v=446'), 'CSS V442 caricato in player');
...
assert(app.includes('DEPLOY_EXPECTED_VERSION_V181 = "446"') || app.includes('DEPLOY_EXPECTED_VERSION_V181 = "445"') || app.includes('DEPLOY_EXPECTED_VERSION_V181 = "444"'), 'runtime atteso V442+');
