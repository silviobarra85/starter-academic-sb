...
assert(index.includes('panel-title-stack-v442.css?v=453'), 'CSS V442 caricato in index');
assert(competition.includes('panel-title-stack-v442.css?v=453'), 'CSS V442 caricato in competition');
assert(player.includes('panel-title-stack-v442.css?v=453'), 'CSS V442 caricato in player');
...
assert(/DEPLOY_EXPECTED_VERSION_V181 = "(442|443|444|445|446|447|448|449|450|451|452|453)"/.test(app), 'runtime atteso V442+');
