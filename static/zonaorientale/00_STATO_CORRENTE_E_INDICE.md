...
## V513 - Runtime boot fix

- Handoff: `HANDOFF_V513_RUNTIME_BOOT_FIX.md`.
- Stato: fix di avvio per `league-config-v443.js`, footer/cache-buster V513, audit runtime boot dedicato.
