const IOSUDO_CACHE = 'iosudo-shell-v768';
const IOSUDO_SHELL = [
  './',
  './index.html',
  ...
  './assets/icon-192.png',
  './assets/icon-512.png',
  '../fanta-engine/css/iosudo-app-v768.css?v=768',
  '../fanta-engine/js/apps/iosudo-app-v768.js?v=768'
];
...
async function safePrecache() {
  ...
  await Promise.all(IOSUDO_SHELL.map(async function (url) {
    try {
      ...
      // V768: non blocca l'installazione se un asset opzionale non risponde su mobile.
    }
  }));
}
