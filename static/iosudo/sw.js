const IOSUDO_CACHE = 'iosudo-shell-v779';
const IOSUDO_SHELL = [
  './',
  './index.html',
  ...
  './assets/icon-192.png',
  './assets/icon-512.png',
  '../fanta-engine/css/iosudo-app-v779.css?v=779',
  '../fanta-engine/js/apps/iosudo-app-v779.js?v=779'
];
...
// V779: cache applicazione sincronizzata con dati V166.
