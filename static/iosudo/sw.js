const IOSUDO_CACHE = 'iosudo-shell-v778';
const IOSUDO_SHELL = [
  './',
  './index.html',
  ...
  './assets/icon-192.png',
  './assets/icon-512.png',
  '../fanta-engine/css/iosudo-app-v778.css?v=778',
  '../fanta-engine/js/apps/iosudo-app-v778.js?v=778'
];
...
// V778: cache applicazione sincronizzata con dati V165.
