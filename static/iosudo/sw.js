const IOSUDO_CACHE = 'iosudo-shell-v780';
const IOSUDO_SHELL = [
  './',
  './index.html',
  ...
  './assets/icon-192.png',
  './assets/icon-512.png',
  '../fanta-engine/css/iosudo-app-v780.css?v=780',
  '../fanta-engine/js/apps/iosudo-app-v780.js?v=780'
];
...
// V780: cache applicazione sincronizzata con dati V167.
