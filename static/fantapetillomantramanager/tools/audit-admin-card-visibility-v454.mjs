...
try {
  ...
  check(index.includes('admin-card-visibility-v455.css?v=455'), 'CSS selettore Admin linkato');
  check(index.includes('admin-card-visibility-v455.js?v=455'), 'JS selettore Admin linkato');
