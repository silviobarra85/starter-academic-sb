...
check('index carica loader V443', index.includes('league-config-v443.js?v=452'));
check('standalone caricano loader V443', competition.includes('league-config-v443.js?v=452') && player.includes('league-config-v443.js?v=452'));
