...
assert(index.includes('panel-title-stack-v442.css?v=466'), 'CSS V442 caricato in index');
assert(competition.includes('panel-title-stack-v442.css?v=466'), 'CSS V442 caricato in competition');
assert(player.includes('panel-title-stack-v442.css?v=466'), 'CSS V442 caricato in player');
