export function installTradeNotificationSimulatorV255(deps = {}) {
  ...
  function getTestCommands() {
    return [
      ...
      },
      {
        ...
        command: 'FantaPetilloTradeSimulatorV255.simulateResolvedSentProposal({ status: "ACCEPTED" })',
        expected: 'Badge mittente visibile e card nella sezione Trattative inviate.'
      },
      {
        name: 'Esito rifiutato su proposta inviata',
        command: 'FantaPetilloTradeSimulatorV255.simulateResolvedSentProposal({ status: "REJECTED" })',
        expected: 'Badge mittente visibile e card nella sezione Trattative inviate.'
      },
      {
        name: 'Marca tutti gli esiti come letti',
        command: 'await FantaPetilloTradeSimulatorV255.markAllOutcomeSeen()',
      ...
      },
      {
        ...
        command: 'FantaPetilloTradeSimulatorV255.clearLocalSimulations()',
        expected: 'Rimuove righe simulate locali e ridisegna badge/card.'
      },
      {
        name: 'Crea proposta reale Firebase',
        command: 'await FantaPetilloTradeSimulatorV255.createFirebaseSentProposal({ confirm: true })',
  ...
  window.FantaPetilloTradeSimulatorV255 = api;
