...
## V324 - Calciomercato card pulite
...
## V325 - Timeline Calciomercato
- Aggiunta vista opzionale Timeline agli articoli Calciomercato.
- Ripristinati/rafforzati i download JSON filtrati e completi.
- La lista articoli resta la vista predefinita.
- Nessuna modifica a Fantamercato interno, Listone, Rose, Admin, Firebase o EmailJS.
