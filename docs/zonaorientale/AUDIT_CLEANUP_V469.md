...
La V469 corregge il gate dopo la V468: il cleanup CSS legacy V343 non deve fallire per riferimenti storici o duplicati fuori dal runtime di ZonaOrientale, ad esempio copie in `static/assets` o nel clone `static/fantapetillomantramanager`.
...
- Il check del clone FantaPetillo viene riallineato alla versione V469.
