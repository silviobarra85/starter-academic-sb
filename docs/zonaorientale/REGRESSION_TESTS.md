...
## Test V323 - Scheda entita Calciomercato

- Calciomercato: clic su chip squadra apre scheda squadra.
- Calciomercato: clic su chip giocatore/allenatore apre scheda nome.
- Calciomercato: filtri squadra/topic/fonte, range e caricamento articoli piu vecchi restano funzionanti.
- Regressione: Fantamercato interno, Listone pubblico/Admin, Rose, Dashboard Presidente e Admin non devono cambiare.
