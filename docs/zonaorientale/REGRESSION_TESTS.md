...
## Test V325 - Timeline Calciomercato
- Calciomercato apre in vista Lista.
- Pulsante Timeline raggruppa per giorno.
- Filtri Squadre / Topic / Fonti funzionano in Lista e Timeline.
- Download JSON filtrati e completo funzionano.
- Carica articoli piu vecchi non riporta in alto.
- Fantamercato interno, Listone, Rose, Dashboard Presidente e Admin invariati.
