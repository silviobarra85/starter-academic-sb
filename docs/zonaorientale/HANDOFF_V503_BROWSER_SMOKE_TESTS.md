...
La V503 aggiunge test browser Playwright comuni in `static/fanta-engine`. La lega ZonaOrientale non cambia logica runtime: footer/cache-buster passano a V503 e la config dichiara i browser smoke tests.
