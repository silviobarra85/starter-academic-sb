...
## V601 - Sudatori Excel TMW aggiornato
...
- **V601**: correzione UI del campetto Sudatori: lato destro/sinistro coerente con i ruoli, badge fisico nascosto per disponibili, badge rosso solo per segnalazioni, rimozione badge **Probabile XI** dalla colonna **Mercato**.
...
- **V601**: corretto orientamento ruoli sul campo, badge fisici sul campo e colonna Mercato.
...
## V601 - Sudatori Excel serale

- Applicato aggiornamento serale TMW al dataset Sudatori.
- Aggiunti movimenti ufficiali, nuove amichevoli e trattative serali.
- Mantenute correzioni UI V598/V599.
