...
## V600 - Sudatori Excel TMW aggiornato
...
- **V600**: correzione UI del campetto Sudatori: lato destro/sinistro coerente con i ruoli, badge fisico nascosto per disponibili, badge rosso solo per segnalazioni, rimozione badge **Probabile XI** dalla colonna **Mercato**.
...
- **V600**: corretto orientamento ruoli sul campo, badge fisici sul campo e colonna Mercato.
